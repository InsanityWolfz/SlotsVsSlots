...
export const TUTORIAL: Record<'preview' | 'fight' | 'firstSpin' | 'ability' | 'draft' | 'shop' | 'next', Tip[]> = {
  ...
  draft: [
    ...
    { title: 'CHARMS AND RELICS', text: 'A CHARM UPGRADES ONE SYMBOL ON ONE REEL (GOLD PAYS X2). LAND THE SAME CHARM ON ALL 3 PAYLINE CELLS FOR A FULL SET BONUS ON TOP. RELICS ARE PASSIVE RULES THAT LAST THE WHOLE RUN.' },
  ],
