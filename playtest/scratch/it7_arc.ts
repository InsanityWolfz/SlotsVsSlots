// I7 arc check vs the ITERATION_6 targets: per-cabinet act 2 clear under several policies, Mirror win +
// REFLECTION firing, per-attempt act 2 lethality B1..B5, and per-node feel.   npx tsx playtest/scratch/it7_arc.ts [N]
import { avg, batch, CABINET_ORDER, LABEL, pct, type FightRec, type Policy, type RunRec } from './it7_lib';
