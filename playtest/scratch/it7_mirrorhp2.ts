...
const FORMULAS: Record<string, F> = {
  ...
  'cap20 4c+55': (r) => Math.round(4 * cappedPower(r, 20).power + 55),
  'cap20 5c+50': (r) => Math.round(5 * cappedPower(r, 20).power + 50),
  'cap20 6c+40': (r) => Math.round(6 * cappedPower(r, 20).power + 40),
  'cap30 4c+50': (r) => Math.round(4 * cappedPower(r, 30).power + 50),
  'flat 150': () => 150,
};
