...
- Public build:  → dist/ with no TUNE panel, no debug, no dev unlock/overrides, relative paths (base './'); HOSTING.md explains itch.io/Netlify/GitHub Pages. Meta progression (unlocks, stakes, act 3, TRUE ENDING, settings) already persists in localStorage.
